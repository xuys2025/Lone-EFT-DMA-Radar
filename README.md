...
- **队友被瞄准警报**：当敌人（或任何非友军）瞄准你的队友时，其瞄准指示线也会延长（高威胁警报），不仅限于瞄准你自己。
- **默认颜色调整**：
  - Scav: 白色
  - pScav (玩家Scav): 黄色
  - Raider: 紫罗兰色
...
## ③ 下一步计划 (Roadmap)
1. **重新设计战局内物资选择器**：采用更硬朗的“Atomic风格”UI设计，提升交互体验。
2. **设置菜单重构**：重新组织设置选项，并为颜色设置添加实时预览功能，所见即所得。
3. **地图旋转主菜单化**：将地图旋转控制移至主菜单，方便快速调整视角。
